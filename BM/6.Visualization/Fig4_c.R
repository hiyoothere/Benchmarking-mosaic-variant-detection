...
##NEW AS LINE
F1 <- read.csv("/Users/tinkertwerk/Desktop/Results/Figures/Figure3/filter/Fil_ana.4.MTF1.txt",sep = '\t',header=FALSE)
...
data = read.csv("/Users/tinkertwerk/Desktop/Results/Figures/Figure3/filter/Fil_ana.4.MT.log.txt",sep = '\t',header=TRUE)
data
