...
## MosaicHunter paired mode - modified version for shared variant detection
## If the joint posterior probabiliy of mosaic-mosaic is larger than log10(0.05) and if it is the highest prob. among all
