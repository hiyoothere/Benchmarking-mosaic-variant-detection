...
for tool in tool_list:
	dic_vaf_ans = {}
        dic_vaf_call = {}
	out = open('single_Perf_by_VAF.hc.ind.txt','a')
	filelist = glob.glob("/data/project/MRS/4.Analysis_Mosaic/" + tool + "/7.IND_A/tp/*M*TP.vcf")
	l_cnt = []
	...
	for i in l_key:
        ...
        fpfilelist = glob.glob("/data/project/MRS/4.Analysis_Mosaic/" + tool + "/7.IND_A/mx/*M*FP.vcf")
	fp2 =  glob.glob("/data/project/MRS/4.Analysis_Mosaic/" + tool + "/7.IND_A/tp/*M*FP.vcf")
